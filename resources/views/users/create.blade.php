                   ...
                   <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="salary" class="form-control form-control-sm" id="address" placeholder="Enter Salary" value="">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" name="education" class="form-control form-control-sm" id="address" placeholder="Enter Salary" value="">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="date" name="dob" class="form-control form-control-sm"  placeholder="Enter Fee Category name" autocomplete="off">
                         ...
                         <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="date" name="join_date" class="form-control form-control-sm" id="datepicker" placeholder="Enter Join date" autocomplete="off">
